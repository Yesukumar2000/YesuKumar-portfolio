  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>Yesu Kumar Bhuvanagiri</h2>
        <p className='i_am_a'>I am a&nbsp;<span class="typewriter"></span></p>
        
        <div className="flex1">
        <p className='follow_me'>follow me: </p>
        <div className="logos">
        {/* <a href="https://github.com/Yesukumar2000"><img src={codechef} alt="" /></a> */}
        <a href="https://github.com/Yesukumar2000" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="https://www.linkedin.com/in/yesukumarb/" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
        {/* <a href="https://github.com/Yesukumar2000/" target="_blank" rel="noreferrer"><img src={leetcodes} alt=""></img></a> */}
        </div>
        </div>
        <div className="flex1">
        <a href="mailto:kumaryesu2000@gmail.com"><button className='buttonc'>E-Mail Me</button></a>
        <button onClick={() => window.open("https://drive.google.com/file/d/15-YFQUyV9RURu5szWmp7LwNnW06KzAsk/view", "_blank")} className='buttonb'>Resume</button>
        </div>
      </div>
